                ...
                <div className={styles.info}>
                  <div className={styles.menu}>
                    <ul className={styles.list}>
                      ...
                      <li>
                        <Link className={styles.infoLink} to={'/about'}>О нас</Link>
                      </li>
                      <li>
                        <Link className={styles.infoLink} to={'/catalog'}>Каталог</Link>
                      </li>
                      <li>
                        <Link className={styles.infoLink} to={'/contacts'}>Контакты</Link>
                      </li>
                    </ul>
                  </div>
